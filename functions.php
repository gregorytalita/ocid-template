...
function twentytwenty_sidebar_registration() {
	...
	register_sidebar(
		array_merge(
			$shared_args,
			array(
				'name'        => __( 'Menu Footer', 'twentytwenty' ),
				'id'          => 'sidebar-2',
	...
	register_sidebar(
		array_merge(
			$shared_args,
			array(
				'name'        => __( 'Informational Footer', 'twentytwenty' ),
				'id'          => 'sidebar-1',
	...
	register_sidebar(
		array_merge(
			$shared_args,
			array(
				'name'        => __( 'Logo Footer', 'twentytwenty' ),
				'id'          => 'sidebar-3',
				'description' => __( 'Widgets in this area will be displayed in the side column in the footer.', 'twentytwenty' ),
			)
		)
	);
	...
	register_sidebar(
		array_merge(
			$shared_args,
			array(
				'name'        => __( 'Copyright Footer', 'twentytwenty' ),
				'id'          => 'sidebar-4',
				'description' => __( 'Widgets in this area will be displayed in the top of the copyright.', 'twentytwenty' ),
			)
		)
	);
...
function twentytwenty_get_elements_array() {
	...
	$elements = array(
		...
		'header-footer' => array(
			'accent'     => array(
				'color'            => array( 'body:not(.overlay-header) .primary-menu > li > .icon', '.modal-menu a', '.footer-menu a, .footer-widgets a', '#site-footer .wp-block-button.is-style-outline', '.wp-block-pullquote:before', '.singular:not(.overlay-header) .entry-header a', '.archive-header a', '.header-footer-group .color-accent', '.header-footer-group .color-accent-hover:hover' ),
